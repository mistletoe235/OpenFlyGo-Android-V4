    ...
    fun evaluate(
        ...
        if (minimumPlannedInterval != null &&
            ...
            reasons += context?.getString(
                ...
                currentCamera.minimumCaptureIntervalSeconds, minimumPlannedInterval)
        }
        ...
        if (pitchOutsideRange != null) {
            reasons += context?.getString(
                R.string.mission_gimbal_pitch_out_of_range,
                pitchOutsideRange.gimbalPitchDegrees,
            ) ?: "Mission gimbal pitch %.1f° is outside the execution range -90° to 30°".format(
                pitchOutsideRange.gimbalPitchDegrees)
        }
