...
SOURCE_SINKS = (
    ...
    "showPreviewStatus", "showMessage(", "showError(", "publish(",
    "pauseInternal(", "abortInternal(", "cancelAutoTakeoff(", "stopFromHil(",
    "showStatus(", "show(", "stopControl(", "runControl(", "runWorker(",
    "cancelPendingFrameRequest(", "simulatorStatusMessage", "renderSurveyStatus",
    "showSurveyGenerationFailure", "confirmDangerousAction", "setSurveySimulatorStatus",
