...
object SurveyPlanner {
    ...
    fun speedLimit(camera: CameraProfile, constraints: SurveyConstraints): SpeedLimit {
        ...
        return SpeedLimit(
            ...
            exceeded = usesNadir &&
                ...
                (usesOblique && constraints.obliqueSpeedMetersPerSecond >
                    obliqueMaximum.coerceAtMost(hardMaximum) + 1.0e-9),
        )
    }
    ...
    private fun estimateOperationalPath(
        ...
        legs.forEach { leg ->
            ...
            val verticalSpeed = if (leg.phase == SurveyExecutionPhase.SAFE_CLIMB) {
