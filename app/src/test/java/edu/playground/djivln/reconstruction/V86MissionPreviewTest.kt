...
class V86MissionPreviewTest {
    ...
    @Test fun `schema14 preview remains separate from flight approval`() {
        val raw = mission().put("schema_version", 14).put("recapture_flight_mode", "CONTINUOUS_EXPERIMENTAL").toString()
