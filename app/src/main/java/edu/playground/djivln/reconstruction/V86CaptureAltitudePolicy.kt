...
object V86CaptureAltitudePolicy {
    data class Resolution(val absoluteAltitudeMeters: Double, val source: String)
    ...
    fun resolve(
        ...
        frameAbsoluteAltitudeMeters?.takeIf(Double::isFinite)?.let {
            return Resolution(it, frameAbsoluteAltitudeSource ?: "aircraft_asl")
        }
