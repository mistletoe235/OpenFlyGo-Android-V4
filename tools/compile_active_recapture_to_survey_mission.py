...
def region_metadata(regions: dict, pass_metadata: list[dict]) -> list[dict]:
    result = []
...
def compile_mission(source: dict, regions: dict, name: str, speed: float) -> dict:
    ...
    return {
        ...
        "active_mapping": {
            ...
            "regions": region_metadata(regions, passes),
            "passes": passes,
        },
    }
...
def main() -> None:
    ...
    mission = compile_mission(source, regions, args.name, args.speed_mps)
