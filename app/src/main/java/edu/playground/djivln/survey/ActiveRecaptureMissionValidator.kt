...
object ActiveRecaptureMissionValidator {
    ...
    private const val OBSOLETE_TWO_BUILDINGS_SELECTION_METHOD =
        "existing seven-region micro-sequences + Android SurveyPlanner R8/R9 five-direction scan + established automatic bridge rule"
    ...
    fun validate(mission: SurveyMission): ActiveRecaptureValidationReport {
        ...
        require(metadata.selectionMethod != OBSOLETE_TWO_BUILDINGS_SELECTION_METHOD) {
            "obsolete two_buildings R8/R9 research mission is explicitly blocked from import and flight"
        }
